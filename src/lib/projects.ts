...
export const projects: Project[] = [
  {
    ...
    live: "https://finsight-aman.vercel.app",
  ...
  },
  {
    ...
    live: "https://headlessblog-aman.vercel.app",
  ...
  },
  {
    ...
    live: "https://vitalswatch-aman.vercel.app",
  ...
  },
  {
    ...
    live: "https://formcraft-aman.vercel.app",
  ...
  {
    slug: "mutualfund-tracker",
    title: "MutualFund Portfolio Tracker",
    tagline: "Track SIPs, holdings, and portfolio performance with Indian MF data",
    description:
      "A full-stack mutual fund portfolio tracker for Indian investors. Manage holdings, track SIP plans, explore 1,000+ funds by category, compare up to 3 funds side-by-side, and visualize 12-month portfolio growth — all with a clean dashboard and real-time search.",
    longDescription:
      "MutualFund Portfolio Tracker is a production-ready Next.js 15 app designed for retail Indian investors. The dashboard shows live portfolio value, daily gain/loss, XIRR-based returns, and a 12-month area chart. The funds explorer supports fuzzy search and category filtering across large fund datasets. The SIP calculator uses the compound interest formula to project corpus at maturity, visualized as a BarChart. The compare view renders a synchronized LineChart for up to 3 funds. Data layer uses TanStack Query with stale-while-revalidate caching, while Drizzle ORM + PostgreSQL powers the production database layer.",
    tech: [
      "Next.js 15",
      "TypeScript",
      "TanStack Query",
    ...
    highlights: [
      "12-month portfolio growth chart with area gradient",
      "Fund explorer with fuzzy search and category tabs",
      "SIP calculator with compound interest projection and BarChart",
      "3-fund comparison view with synchronized LineChart",
      "Drizzle ORM schema for production DB (PostgreSQL)",
      "TanStack Query caching with stale-while-revalidate",
    ],
    metrics: [
      { value: "8", label: "Fund categories" },
      { value: "12mo", label: "Portfolio history" },
      { value: "3-way", label: "Fund comparison" },
    ],
    live: "https://mftracker-aman.vercel.app",
    github: "https://github.com/amansoni1605/mutualfund-tracker",
    badge: "Finance",
    badgeColor: "emerald",
    category: "personal",
  },
  {
    slug: "standupbot",
    title: "StandupBot",
    tagline: "Team daily standup manager with streaks, blockers, and history",
    description:
      "A team standup tool that replaces the daily status-update meeting. Team members submit yesterday / today / blockers via a clean form, teammates see each other's updates in a real-time feed, and managers track streaks, consistency, and active blockers from a single dashboard.",
    longDescription:
      "StandupBot is a full-stack team productivity app built on Next.js 15 App Router. The main standup form uses React Hook Form + Zod for validated submission with mood selection and blocker flagging. The feed page shows all team standups grouped by date with like reactions and mood emojis. The history page renders a monthly calendar with color-coded submission dots per team member. The blockers page lets anyone mark an item as resolved. The streaks leaderboard visualizes 4-week submission rates as a BarChart. Settings manage team info, standup window, and Slack/email notification config.",
    tech: [
      "Next.js 15",
      "TypeScript",
      "React Hook Form",
    ...
    highlights: [
      "Standup form with React Hook Form + Zod and mood selection",
      "Team feed with date navigation, like reactions, and mood emoji",
      "Monthly calendar history with per-member color dots",
      "Active blockers tracker with resolve toggle",
      "Streak leaderboard with 4-week BarChart visualization",
      "Notification settings for Slack and email integration",
    ],
    metrics: [
      { value: "5", label: "Team members" },
      { value: "7", label: "Days of history" },
      { value: "4wk", label: "Streak tracking" },
    ],
    live: "https://standupbot-aman.vercel.app",
    github: "https://github.com/amansoni1605/standupbot",
    badge: "Productivity",
    badgeColor: "violet",
    category: "personal",
  },
